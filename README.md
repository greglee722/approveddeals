...
| v2.6 | (undocumented changes) |
| v2.7 | (undocumented changes) |
| v2.8 | (undocumented changes) |
| v2.9 | (undocumented changes) |
| v3.0 | Copy Emails functionality moved from main Clients page to individual deal detail Clients tile; only appears when at least one client has email on file; removes global "Copy All Emails" button |
| v3.1 | (internal) Welcome Email Draft feature developed |
| v3.2 | (skipped — local version) |
| v3.3 | Welcome Email Draft — "Generate Welcome Email" button on deal detail page; generates a pre-filled client welcome email from deal data; modal shows To, Subject, editable body; supports Copy Body and Open in Mail Client |
| v3.4 | Fix blank address in welcome email — `resolveDealAddress()` falls back to `deal.name` before showing placeholder |
